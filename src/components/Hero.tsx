...
export default function Hero() {
  return (
    <section className="hero-retro px-5 py-12 md:px-8 md:py-16" aria-labelledby="hero-title">
      <div className="container mx-auto max-w-6xl">
        <img src="/estrela.png" alt="" className="hero-star" aria-hidden="true" />

        <div className="grid items-center gap-12 lg:gap-24 lg:grid-cols-[1.05fr_.95fr]">
          <div className="relative order-2 lg:order-1">
            <img src="/Gemini.png" alt="Ilustração da SAINF XIII" className="monitor-logo" />
          </div>

          <div className="order-1 text-center lg:order-2 lg:text-left">
            <p className="pixel-title mb-4 text-lg text-primary">SEMANA ACADÊMICA DE INFORMÁTICA</p>
