    ...
    return (
        <section id="cronograma" className="py-20 bg-base-200">
            <div className="container mx-auto max-w-7xl px-6">
                ...
                {/* Aviso de Cronograma em Construção */}
                <div className="alert alert-warning shadow-lg mb-8 max-w-3xl mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <div>
                        <h3 className="font-bold">Cronograma em atualização</h3>
                        <div className="text-xs">A programação completa ainda está sendo finalizada. Fique atento às atualizações!</div>
                    </div>
                </div>
                    ...
                    <div role="tablist" className="tabs tabs-boxed bg-base-100 p-2 shadow-lg w-full max-w-md">
                        {cronogramaEventos.map((dia, index) => (
                            <button
                                key={index}
                                role="tab"
                                className={`tab text-sm md:text-base ${activeTab === index ? 'tab-active' : ''
                                    }`}
